...
const AllAppointments = () => {
    ...
    const { aToken, appointments, appointmentsLoading, getAllAppointments, cancelAppointment } = useContext(AdminContext)
            ...
            <div className='bg-white border rounded text-sm max-h-[80vh] min-h-[80vh] overflow-y-scroll '>
                {appointmentsLoading ? (
                    <LoadingState
                        ...
                        message='We are fetching bookings, patient details, doctor assignments, and status updates.'
                        variant='table'
                        className='m-4'
                    />
                ) : (
